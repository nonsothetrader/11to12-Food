...
export default function SignupPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/signup/complete-profile?email=${encodeURIComponent(userCredential.user.email || '')}`);
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      router.push(`/signup/complete-profile?email=${encodeURIComponent(user.email || '')}`);
  ...
  return (
    <Card className="w-full max-w-sm">
      <CardHeader>
        ...
        <CardDescription>
          Get started with the easiest lunch plan ever.
        </CardDescription>
      </CardHeader>
